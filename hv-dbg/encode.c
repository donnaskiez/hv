...
{
        Fields->natural_state.cr0       = EncodeField(VMCS_ACCESS_FULL,
                                                VMCS_TYPE_GUEST_STATE,
                                                VMCS_WIDTH_NATURAL,
                                                0);
        Fields->natural_state.cr3       = EncodeField(VMCS_ACCESS_FULL,
                                                VMCS_TYPE_GUEST_STATE,
                                                VMCS_WIDTH_NATURAL,
                                                1);
        Fields->natural_state.cr4       = EncodeField(VMCS_ACCESS_FULL,
                                                VMCS_TYPE_GUEST_STATE,
                                                VMCS_WIDTH_NATURAL,
                                                2);
        Fields->natural_state.es_base   = EncodeField(VMCS_ACCESS_FULL,
                                                    VMCS_TYPE_GUEST_STATE,
                                                    VMCS_WIDTH_NATURAL,
                                                    3);
        Fields->natural_state.cs_base   = EncodeField(VMCS_ACCESS_FULL,
                                                    VMCS_TYPE_GUEST_STATE,
                                                    VMCS_WIDTH_NATURAL,
                                                    4);
        Fields->natural_state.ss_base   = EncodeField(VMCS_ACCESS_FULL,
                                                    VMCS_TYPE_GUEST_STATE,
                                                    VMCS_WIDTH_NATURAL,
                                                    5);
        Fields->natural_state.ds_base   = EncodeField(VMCS_ACCESS_FULL,
                                                    VMCS_TYPE_GUEST_STATE,
                                                    VMCS_WIDTH_NATURAL,
                                                    6);
        Fields->natural_state.fs_base   = EncodeField(VMCS_ACCESS_FULL,
                                                    VMCS_TYPE_GUEST_STATE,
                                                    VMCS_WIDTH_NATURAL,
                                                    7);
        Fields->natural_state.gs_base   = EncodeField(VMCS_ACCESS_FULL,
                                                    VMCS_TYPE_GUEST_STATE,
                                                    VMCS_WIDTH_NATURAL,
                                                    8);
        Fields->natural_state.ldtr_base = EncodeField(VMCS_ACCESS_FULL,
                                                      VMCS_TYPE_GUEST_STATE,
                                                      VMCS_WIDTH_NATURAL,
                                                      9);
        Fields->natural_state.tr_base   = EncodeField(VMCS_ACCESS_FULL,
                                                    VMCS_TYPE_GUEST_STATE,
                                                    VMCS_WIDTH_NATURAL,
                                                    10);
        Fields->natural_state.gdtr_base = EncodeField(VMCS_ACCESS_FULL,
                                                      VMCS_TYPE_GUEST_STATE,
                                                      VMCS_WIDTH_NATURAL,
                                                      11);
        Fields->natural_state.idtr_base = EncodeField(VMCS_ACCESS_FULL,
                                                      VMCS_TYPE_GUEST_STATE,
                                                      VMCS_WIDTH_NATURAL,
                                                      12);
        Fields->natural_state.dr7       = EncodeField(VMCS_ACCESS_FULL,
                                                VMCS_TYPE_GUEST_STATE,
                                                VMCS_WIDTH_NATURAL,
                                                13);
        Fields->natural_state.rsp       = EncodeField(VMCS_ACCESS_FULL,
                                                VMCS_TYPE_GUEST_STATE,
                                                VMCS_WIDTH_NATURAL,
                                                14);
        Fields->natural_state.rip       = EncodeField(VMCS_ACCESS_FULL,
                                                VMCS_TYPE_GUEST_STATE,
                                                VMCS_WIDTH_NATURAL,
                                                15);
        Fields->natural_state.rflags    = EncodeField(VMCS_ACCESS_FULL,
                                                   VMCS_TYPE_GUEST_STATE,
                                                   VMCS_WIDTH_NATURAL,
                                                   16);
        Fields->natural_state.pending_debug_exceptions =
            EncodeField(VMCS_ACCESS_FULL,
                        VMCS_TYPE_GUEST_STATE,
                        VMCS_WIDTH_NATURAL,
                        17);
        Fields->natural_state.sysenter_esp = EncodeField(VMCS_ACCESS_FULL,
                                                         VMCS_TYPE_GUEST_STATE,
                                                         VMCS_WIDTH_NATURAL,
                                                         18);
        Fields->natural_state.sysenter_eip = EncodeField(VMCS_ACCESS_FULL,
                                                         VMCS_TYPE_GUEST_STATE,
                                                         VMCS_WIDTH_NATURAL,
                                                         19);
        ...
        Fields->qword_state.vmcs_link_pointer =
            EncodeField(VMCS_ACCESS_FULL,
                        ...
                        VMCS_WIDTH_64,
                        0);
        Fields->qword_state.debug_control = EncodeField(VMCS_ACCESS_FULL,
                                                        VMCS_TYPE_GUEST_STATE,
                                                        VMCS_WIDTH_64,
                                                        1);
        Fields->qword_state.pat           = EncodeField(VMCS_ACCESS_FULL,
                                              VMCS_TYPE_GUEST_STATE,
                                              VMCS_WIDTH_64,
                                              2);
        Fields->qword_state.efer          = EncodeField(VMCS_ACCESS_FULL,
                                               VMCS_TYPE_GUEST_STATE,
                                               VMCS_WIDTH_64,
                                               3);
        Fields->qword_state.perf_global_control =
            EncodeField(VMCS_ACCESS_FULL,
                        ...
                        VMCS_WIDTH_64,
                        4);
        Fields->qword_state.pdpte0 = EncodeField(VMCS_ACCESS_FULL,
                                                 VMCS_TYPE_GUEST_STATE,
                                                 VMCS_WIDTH_64,
                                                 5);
        Fields->qword_state.pdpte1 = EncodeField(VMCS_ACCESS_FULL,
                                                 VMCS_TYPE_GUEST_STATE,
                                                 VMCS_WIDTH_64,
                                                 6);
        Fields->qword_state.pdpte2 = EncodeField(VMCS_ACCESS_FULL,
                                                 VMCS_TYPE_GUEST_STATE,
                                                 VMCS_WIDTH_64,
                                                 7);
        Fields->qword_state.pdpte3 = EncodeField(VMCS_ACCESS_FULL,
                                                 VMCS_TYPE_GUEST_STATE,
                                                 VMCS_WIDTH_64,
                                                 8);
        ...
        Fields->dword_state.es_limit   = EncodeField(VMCS_ACCESS_FULL,
                                                   VMCS_TYPE_GUEST_STATE,
                                                   VMCS_WIDTH_32,
                                                   0);
        Fields->dword_state.cs_limit   = EncodeField(VMCS_ACCESS_FULL,
                                                   VMCS_TYPE_GUEST_STATE,
                                                   VMCS_WIDTH_32,
                                                   1);
        Fields->dword_state.ss_limit   = EncodeField(VMCS_ACCESS_FULL,
                                                   VMCS_TYPE_GUEST_STATE,
                                                   VMCS_WIDTH_32,
                                                   2);
        Fields->dword_state.ds_limit   = EncodeField(VMCS_ACCESS_FULL,
                                                   VMCS_TYPE_GUEST_STATE,
                                                   VMCS_WIDTH_32,
                                                   3);
        Fields->dword_state.fs_limit   = EncodeField(VMCS_ACCESS_FULL,
                                                   VMCS_TYPE_GUEST_STATE,
                                                   VMCS_WIDTH_32,
                                                   4);
        Fields->dword_state.gs_limit   = EncodeField(VMCS_ACCESS_FULL,
                                                   VMCS_TYPE_GUEST_STATE,
                                                   VMCS_WIDTH_32,
                                                   5);
        Fields->dword_state.ldtr_limit = EncodeField(VMCS_ACCESS_FULL,
                                                     VMCS_TYPE_GUEST_STATE,
                                                     VMCS_WIDTH_32,
                                                     6);
        Fields->dword_state.tr_limit   = EncodeField(VMCS_ACCESS_FULL,
                                                   VMCS_TYPE_GUEST_STATE,
                                                   VMCS_WIDTH_32,
                                                   7);
        Fields->dword_state.gdtr_limit = EncodeField(VMCS_ACCESS_FULL,
                                                     VMCS_TYPE_GUEST_STATE,
                                                     VMCS_WIDTH_32,
                                                     8);
        Fields->dword_state.idtr_limit = EncodeField(VMCS_ACCESS_FULL,
                                                     VMCS_TYPE_GUEST_STATE,
                                                     VMCS_WIDTH_32,
                                                     9);
        ...
        Fields->dword_state.interruptibility_state =
            EncodeField(VMCS_ACCESS_FULL,
                        ...
                        VMCS_WIDTH_32,
                        18);
        Fields->dword_state.activity_state = EncodeField(VMCS_ACCESS_FULL,
                                                         VMCS_TYPE_GUEST_STATE,
                                                         VMCS_WIDTH_32,
                                                         19);
        Fields->dword_state.smbase         = EncodeField(VMCS_ACCESS_FULL,
                                                 VMCS_TYPE_GUEST_STATE,
                                                 VMCS_WIDTH_32,
                                                 20);
        Fields->dword_state.sysenter_cs    = EncodeField(VMCS_ACCESS_FULL,
                                                      VMCS_TYPE_GUEST_STATE,
                                                      VMCS_WIDTH_32,
                                                      21);
        ...
        Fields->word_state.es_selector      = EncodeField(VMCS_ACCESS_FULL,
                                                     VMCS_TYPE_GUEST_STATE,
                                                     VMCS_WIDTH_16,
                                                     0);
        Fields->word_state.cs_selector      = EncodeField(VMCS_ACCESS_FULL,
                                                     VMCS_TYPE_GUEST_STATE,
                                                     VMCS_WIDTH_16,
                                                     1);
        Fields->word_state.ss_selector      = EncodeField(VMCS_ACCESS_FULL,
                                                     VMCS_TYPE_GUEST_STATE,
                                                     VMCS_WIDTH_16,
                                                     2);
        Fields->word_state.ds_selector      = EncodeField(VMCS_ACCESS_FULL,
                                                     VMCS_TYPE_GUEST_STATE,
                                                     VMCS_WIDTH_16,
                                                     3);
        Fields->word_state.fs_selector      = EncodeField(VMCS_ACCESS_FULL,
                                                     VMCS_TYPE_GUEST_STATE,
                                                     VMCS_WIDTH_16,
                                                     4);
        Fields->word_state.gs_selector      = EncodeField(VMCS_ACCESS_FULL,
                                                     VMCS_TYPE_GUEST_STATE,
                                                     VMCS_WIDTH_16,
                                                     5);
        Fields->word_state.ldtr_selector    = EncodeField(VMCS_ACCESS_FULL,
                                                       VMCS_TYPE_GUEST_STATE,
                                                       VMCS_WIDTH_16,
                                                       6);
        Fields->word_state.tr_selector      = EncodeField(VMCS_ACCESS_FULL,
                                                     VMCS_TYPE_GUEST_STATE,
                                                     VMCS_WIDTH_16,
                                                     7);
        Fields->word_state.interrupt_status = EncodeField(VMCS_ACCESS_FULL,
                                                          VMCS_TYPE_GUEST_STATE,
                                                          VMCS_WIDTH_16,
                                                          8);
        Fields->word_state.pml_index        = EncodeField(VMCS_ACCESS_FULL,
                                                   VMCS_TYPE_GUEST_STATE,
                                                   VMCS_WIDTH_16,
                                                   9);
}
...
EncodeVmcsHostStateFields(_Out_ PVMCS_HOST_STATE_FIELDS Fields)
{
        ...
        Fields->dword_state.ia32_sysenter_cs = EncodeField(VMCS_ACCESS_FULL,
                                                           VMCS_TYPE_HOST_STATE,
                                                           VMCS_WIDTH_32,
                                                           0);
}
...
EncodeVmcsControlStateFields(_Out_ PVMCS_CONTROL_STATE_FIELDS Fields)
{
        ...
        Fields->natural_state.cr4_guest_host_mask =
            EncodeField(VMCS_ACCESS_FULL,
                        ...
                        VMCS_WIDTH_NATURAL,
                        1);
        Fields->natural_state.cr0_read_shadow = EncodeField(VMCS_ACCESS_FULL,
                                                            VMCS_TYPE_CONTROL,
                                                            VMCS_WIDTH_NATURAL,
                                                            2);
        Fields->natural_state.cr4_read_shadow = EncodeField(VMCS_ACCESS_FULL,
                                                            VMCS_TYPE_CONTROL,
                                                            VMCS_WIDTH_NATURAL,
                                                            3);
...
EncodeVmcsExitStateFields(_Out_ PVMCS_EXIT_STATE_FIELDS Fields)
{
        Fields->natural_state.exit_qualification =
            EncodeField(VMCS_ACCESS_FULL,
                        VMCS_TYPE_EXIT_INFORMATION,
                        VMCS_WIDTH_NATURAL,
                        0);
        Fields->natural_state.io_rcx = EncodeField(VMCS_ACCESS_FULL,
                                                   VMCS_TYPE_EXIT_INFORMATION,
                                                   VMCS_WIDTH_NATURAL,
                                                   1);
        Fields->natural_state.io_rsx = EncodeField(VMCS_ACCESS_FULL,
                                                   VMCS_TYPE_EXIT_INFORMATION,
                                                   VMCS_WIDTH_NATURAL,
                                                   2);
        Fields->natural_state.io_rdi = EncodeField(VMCS_ACCESS_FULL,
                                                   VMCS_TYPE_EXIT_INFORMATION,
                                                   VMCS_WIDTH_NATURAL,
                                                   3);
        Fields->natural_state.io_rip = EncodeField(VMCS_ACCESS_FULL,
                                                   VMCS_TYPE_EXIT_INFORMATION,
                                                   VMCS_WIDTH_NATURAL,
                                                   4);
        ...
        Fields->dword_state.instruction_error =
            EncodeField(VMCS_ACCESS_FULL,
                        ...
                        VMCS_WIDTH_32,
                        0);
        Fields->dword_state.reason = EncodeField(VMCS_ACCESS_FULL,
                                                 VMCS_TYPE_EXIT_INFORMATION,
                                                 VMCS_WIDTH_32,
                                                 1);
