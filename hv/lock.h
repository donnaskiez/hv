...
/*
 * Its assumed that when these functions are called, the irql >= DISPATCH_LEVEL.
 * This means there is no need for us to save the IRQL value and restore the
 * previous IRQL value similar to how KeAcquireSpinLock and the release function
 * work.
 */
